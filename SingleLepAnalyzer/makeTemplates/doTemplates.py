...
pfix = 'v1/templates_M250'
if not isCategorized: pfix='v60/kinematics_'+region+'_NJetsCSV_HighStat_M'
if not isCategorized: pfix='v113/withSys/kinematics_'+region+'_M'

pfix+=massPt+'_2019_12_16'
...
bkgProcs['OtherT']= ['TTTT','TTHB','TTHnoB']
...
def rundoTemp(category):
	iPlotList = []#'minBBdr','aveBBdr','deltaEta_maxBB','FW_momentum_2','centrality','aveCSVpt','HT','minMlb','Bjet1Pt','mass_maxJJJpt','MTlmet','lepDR_minBBdr','MET'
