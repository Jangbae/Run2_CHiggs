...
plotList = {#discriminantName:(discriminantLJMETName, binning, xAxisLabel)
	...
	'Jet4Pt':('AK4JetPt_singleLepCalc_PtOrdered[3]',linspace(0, 800, 51).tolist(),';p_{T}(j_{4}), AK4 [GeV]'),
	'Jet5Pt':('AK4JetPt_singleLepCalc_PtOrdered[4]',linspace(0, 800, 51).tolist(),';p_{T}(j_{5}), AK4 [GeV]'),
	'Jet6Pt':('AK4JetPt_singleLepCalc_PtOrdered[5]',linspace(0, 800, 51).tolist(),';p_{T}(j_{6}), AK4 [GeV]'),	
	...
	'NJets':('NJets_singleLepCalc',linspace(0, 15, 16).tolist(),';jet multiplicity'),
	'NBJetsNoSF':('NJetsCSV_singleLepCalc',linspace(0, 10, 11).tolist(),';b tag multiplicity'),
	'NBJets':('NJetsCSVwithSF_singleLepCalc',linspace(0, 10, 11).tolist(),';b tag multiplicity'),
	...
	'NJets_vs_NBJets':('NJets_singleLepCalc:NJetsCSV_singleLepCalc',linspace(0, 15, 16).tolist(),';jet multiplicity',linspace(0, 10, 11).tolist(),';b tag multiplicity'),
	}
